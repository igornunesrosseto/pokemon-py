...
class Pokemon:
    def __init__(
        self, name, types, moves, EVs, health="==================="
    ):  # primeiro parametro sempre self
    ...
    def fight(self, Pokemon2):
        ...
        for i, t in enumerate(version):  # 0 fire 1 water 2 grass
            if (
                self.types == t
            ):  # entra com t já determinado, exemplo Venusaur self.type, t = grass
                print(i, t)
                # Both are same type
                if Pokemon2.types == t:
        ...
        while (self.bars > 0) and (Pokemon2.bars > 0):
            ...
            # Determine damage
            Pokemon2.bars -= self.attack  # quantidade de barras
            Pokemon2.health = ""  # desenho da barra

            # adiciona de volta desenho da barra de hp baseado na quantidade de hp(bars)restante + defesa
